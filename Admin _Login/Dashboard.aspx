<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="JobPilot.Admin__Login.Dashboard" %>
...
<body>
    <form id="form1" runat="server">
        <div class="app-container  body-tabs-shadow fixed-sidebar fixed-header">
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    ...
                                                    <div class="widget-subheading">
                                                        Makes the header top fixed, always
                                                    visible!
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="app-main">
                <div class="app-sidebar sidebar-shadow bg-dark">
                    <div class="app-header__logo">
                    ...
                    <div class="scrollbar-sidebar bg-dark">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <%-- <a href="#">
                                    <i class="fa-solid fa-money-bill-1 fa-xl" style="color: #18191b;"></i>
                                    Order
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                <h5>Earnings</h5>
                                                <p>
                                                    <asp:Label ID="earningslabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                ...
                                                <p>
                                                    <asp:Label ID="totalCandidatesLabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                <h5>Active Jobs</h5>
                                                <p>
                                                    <asp:Label ID="activejobsLabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                <h5>Expired Jobs</h5>
                                                <p>
                                                    <asp:Label ID="expiredJobsLabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                ...
                                                <p>
                                                    <asp:Label ID="totalCompanieslabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                ...
                                                <p>
                                                    <asp:Label ID="verifiedUsersLabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                <h5>Pending Jobs</h5>
                                                <p>
                                                    <asp:Label ID="pendingJobslabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box">
                                            ...
                                            <div class="box-detail">
                                                <h5>All Jobs</h5>
                                                <p>
                                                    <asp:Label ID="allJobsLabel" runat="server" Text="Label"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="tabs-eg-77">
                                                ...
                                                <h6
                                                    class="text-muted text-uppercase font-size-md opacity-5 font-weight-normal">Top Authors</h6>
