<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="JobPilot.Login" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="login-details">
                        <p class="login-title">Don't have an account? <a href="Register.aspx"><span style="color:blue">Create Account</span></a></p>
                    ...
                    <form id="form1" runat="server">
                        <div class="login-page">
                            <div class="form-group">
                                <asp:TextBox ID="txtEmail" runat="server" type="email" placeholder="Enter email" class="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="txtPassword" runat="server" placeholder="Password" class="form-control" type="password"></asp:TextBox>
                            </div>
                    ...
                    <div class="loginCredentials">
                        <span style="text-align:center"><h5>Login Credentials</h5></span>
                        <div class="row">
                            <div class="col-md-6">
